...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->открыть¬идеоToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			// 
			this->текстовый–едакторToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(2) {
				this->загрузить»зображениеToolStripMenuItem,
					this->открыть¬идеоToolStripMenuItem
			});
			...
			// 
			// открыть¬идеоToolStripMenuItem
			// 
			this->открыть¬идеоToolStripMenuItem->Name = L"открыть¬идеоToolStripMenuItem";
			resources->ApplyResources(this->открыть¬идеоToolStripMenuItem, L"открыть¬идеоToolStripMenuItem");
			this->открыть¬идеоToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::открыть¬идеоToolStripMenuItem_Click);
			// 
			// tabControl1
			// 
...
private: System::Void открыть¬идеоToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	openFileDialog1->ShowDialog();
	if (openFileDialog1->FileName != nullptr)
